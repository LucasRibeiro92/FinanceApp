...
object SnackbarAssistant {
    fun showSnackbar(view: View, message: String, actionText: String? = null, action: (() -> Unit)? = null) {
        ...
        snackbar.view.setBackgroundColor(ContextCompat.getColor(view.context, R.color.mygray2))

        // Customize the text color
        val textView = snackbar.view.findViewById<TextView>(com.google.android.material.R.id.snackbar_text)
        textView.setTextColor(ContextCompat.getColor(view.context, R.color.myyellow2))
        ...
        actionView.setTextColor(ContextCompat.getColor(view.context, R.color.myyellow2))
